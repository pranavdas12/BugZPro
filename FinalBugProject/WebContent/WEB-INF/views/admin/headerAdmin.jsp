...
<div class="sidebar-container">
 ...
 <a href="./DashboardAdmin" onclick="window.location.href='./DashboardAdmin';"> <img src="images/bug.png" align="middle" size="10px 20px"></a>
    BugZPro
  </div>
  <ul class="sidebar-navigation">
      <li class="header">Functions</li>
    <li>
      <a href="./AssignDevServ">
        <i class="fa fa-home" aria-hidden="true"></i> Assign Developers
      </a>
    </li>
    <li>
    ...
    <li>
     ...
     <li>
      <a href="./SearchUserRecord">
        <i class="fa fa-info-circle" aria-hidden="true"></i> Delete User
      </a>
    </li>
    <li>
      <a href="./SendEmail">
        <i class="fa fa-info-circle" aria-hidden="true"></i> Send Email
      </a>
    </li>
    ...
    <li>
      <a href="./ViewFeedback">
        <i class="fa fa-info-circle" aria-hidden="true"></i> View User Feedback's
      </a>
    </li>
    <li>
      <a href="./AboutDev">
